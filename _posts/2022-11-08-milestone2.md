...
| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| XGB Base    | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
| XBG + Freature Selection     | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
| XBG + SMOTE  | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
|  XBG + SMOTE +FS  | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
| NN Base    | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
| NN +SMOTE   | Sensitivity | Specificity      | F1-Score | PPV     | NPV |
